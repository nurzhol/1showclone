...
<head>
    ...
    <title>Каталог артистов - 1show.kz</title>
	...
	<style>.b1-image-in.hide-sm {display:none;}.sidebar{padding-top:200px;}</style>
	<style>
        .b9-banners {
			text-align: center;
		}
...
<video autoplay muted loop id="myVideo3" style="width: 100%;">
	...
	<div class="catalog-block">
		<div class="wrap">
			<div class="cb-title">Каталог свадебных исполнителей Казахстана</div>
			<div class="cb-sep"><img src="images/b2-sep.png" alt="" /></div>
			<div class="cb-box">
				<div class="cb-sub">
					<div class="cb-sub-title">Специалисты:</div>
					<div class="cb-catalog">
							<div class="cb-prod">
					<a href="/catalog/vedushie">
						<div class="cb-icon"><img src="data/cats/vedushie.png" class="h" alt="Ведущие"></div>
						<div class="cb-name">Ведущие</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/zvezdy">
						<div class="cb-icon"><img src="data/cats/zvezdy.png" class="h" alt="Звезды"></div>
						<div class="cb-name">Звезды</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/vokalisty">
						<div class="cb-icon"><img src="data/cats/vokalisty.png" class="h" alt="Вокалисты"></div>
						<div class="cb-name">Вокалисты</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/via">
						<div class="cb-icon"><img src="data/cats/via.png" class="h" alt="ВИА"></div>
						<div class="cb-name">ВИА</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/originalnyi_zhanr">
						<div class="cb-icon"><img src="/data/cats/originalnyi_zhanr.png" class="h" alt="Оригинальный жанр"></div>
						<div class="cb-name">Оригинальный жанр</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/detyam">
						<div class="cb-icon"><img src="data/cats/detyam.png" class="h" alt="Детям"></div>
						<div class="cb-name">Детям</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/tancevalnye_kollektivy">
						<div class="cb-icon"><img src="data/cats/tancevalnye_kollektivy.png" class="h" alt="Танцевальные коллективы"></div>
						<div class="cb-name">Танцевальные коллективы</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/instrumentalisty">
						<div class="cb-icon"><img src="data/cats/instrumentalisty.png" class="h" alt="Инструменталисты"></div>
						<div class="cb-name">Инструменталисты</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/dj_didzhei">
						<div class="cb-icon"><img src="data/cats/dj_didzhei.png" class="h" alt="DJ (Диджеи)"></div>
						<div class="cb-name">DJ (Диджеи)</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/bloggery">
						<div class="cb-icon"><img src="data/cats/lidery_mnenii.png" class="h" alt="Блоггеры"></div>
						<div class="cb-name">Блоггеры</div>
					</a>
				</div>
					</div>
				</div>
				<div class="cb-sub pink">
					<div class="cb-sub-title">Услуги:</div>
					<div class="cb-catalog">
							<div class="cb-prod">
					<a href="/catalog/transportnye_uslugi">
						<div class="cb-icon"><img src="data/cats/transportnye_uslugi.png" class="h" alt="Транспортные услуги"></div>
						<div class="cb-name">Транспортные услуги</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/arenda_oborudovaniya">
						<div class="cb-icon"><img src="data/cats/arenda_oborudovaniya.png" class="h" alt="Аренда оборудования"></div>
						<div class="cb-name">Аренда оборудования</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/atele">
						<div class="cb-icon"><img src="data/cats/atele.png" class="h" alt="Ателье"></div>
						<div class="cb-name">Ателье</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/vyezdnaya_registraciya">
						<div class="cb-icon"><img src="data/cats/vyezdnaya_registraciya.png" class="h" alt="Выездная регистрация"></div>
						<div class="cb-name">Выездная регистрация</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/nacionalnye_obryady">
						<div class="cb-icon"><img src="data/cats/nacionalnye_obryady.png" class="h" alt="Национальные обряды"></div>
						<div class="cb-name">Национальные обряды</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/oformlenie">
						<div class="cb-icon"><img src="data/cats/oformlenie.png" class="h" alt="Оформление "></div>
						<div class="cb-name">Оформление </div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/rezhissery">
						<div class="cb-icon"><img src="data/cats/rezhissery.png" class="h" alt="Режиссеры"></div>
						<div class="cb-name">Режиссеры</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/restorany">
						<div class="cb-icon"><img src="data/cats/restorany.png" class="h" alt="Рестораны"></div>
						<div class="cb-name">Рестораны</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/salony_krasoty">
						<div class="cb-icon"><img src="data/cats/salony_krasoty.png" class="h" alt="Салоны красоты"></div>
						<div class="cb-name">Салоны красоты</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/svadebnye_salony">
						<div class="cb-icon"><img src="data/cats/svadebnye_salony.png" class="h" alt="Свадебные салоны"></div>
						<div class="cb-name">Свадебные салоны</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/konditerskie_izdeliya">
						<div class="cb-icon"><img src="data/cats/konditerskie_izdeliya.png" class="h" alt="Кондитерские изделия"></div>
						<div class="cb-name">Кондитерские изделия</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/studii_zvukozapisi">
						<div class="cb-icon"><img src="data/cats/studii_zvukozapisi.png" class="h" alt="Студии звукозаписи"></div>
						<div class="cb-name">Студии звукозаписи</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/foto_i_video">
						<div class="cb-icon"><img src="data/cats/foto_i_video.png" class="h" alt="Фото и видео"></div>
						<div class="cb-name">Фото и видео</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/yuvelirnye_salony">
						<div class="cb-icon"><img src="data/cats/yuvelirnye_salony.png" class="h" alt="Ювелирные салоны"></div>
						<div class="cb-name">Ювелирные салоны</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/event_kompanii">
						<div class="cb-icon"><img src="data/cats/event_kompanii.png" class="h" alt="Event компании"></div>
						<div class="cb-name">Event компании</div>
					</a>
				</div>	<div class="cb-prod">
					<a href="/catalog/raznoe">
						<div class="cb-icon"><img src="data/cats/raznoe.png" class="h" alt="Разное "></div>
						<div class="cb-name">Разное </div>
					</a>
				</div>
					</div>
				</div>
...
</html><?php /**PATH C:\xampp\htdocs\upwork\upwork\resources\views/catalogs.blade.php ENDPATH**/ ?>