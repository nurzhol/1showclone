...
<head>
    ...
    <title>Аренда лимузинов в Астане: сделайте праздник незабываемым!</title>
...
<video autoplay muted loop id="myVideo3" style="width: 100%;">
	...
	<div class="sidebar">
		<div class="wrap">
			<ul itemscope itemtype="http://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="/catalogs"><span itemprop="name">Каталог</span></a><meta itemprop="position" content="1" /></li><li><span>Транспортные услуги</span></li>
			</ul>
		</div>
	</div>
	<div class="catalog-block">
		<div class="wrap">
			<div class="cb-title">Транспортные услуги</div>
	...
	<option value="9">Фото и видео</option><option value="11">Рестораны</option><option value="12">Режиссеры</option><option value="13" selected>Транспортные услуги</option><option value="14">Аренда оборудования</option><option value="15">Ателье</option><option value="16">Выездная регистрация</option><option value="17">Национальные обряды</option><option value="18">Оформление </option><option value="19">Салоны красоты</option><option value="20">Кондитерские изделия</option><option value="21">Свадебные салоны</option><option value="22">Студии звукозаписи</option><option value="23">Ювелирные салоны</option><option value="24">Event компании</option><option value="25">Разное </option>
						...
						<div class="sp-f-block filt">
							...
							<div class="sp-f-name">Услуги:</div><div class="sp-f-content">								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="53">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">лимузины</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="54">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">автобусы</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="55">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">минивэны</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="56">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">люкс автомобили</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="57">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">авто бизнес класса</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="58">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">авто эконом класса</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="59">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">воздушный транспорт</span>
								</label>								<label>
									<input class="checkbox" type="checkbox" name="filters[]" onchange="change_checkbox(this)" value="60">
									<span class="checkbox-custom"></span>
									<span class="label" style="width:190px;">водный транспорт</span>
								</label></div>
						</div>
						<div class="sp-f-block">
					...
					<div class="sp-spisok">
						...
						<a href="/ankets/2428">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/2428/2428a.jpg' alt="Алматы Limo"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>Алматы Limo</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Алматы</div>
										<div class="sp-o-view">1456</div>
										<div class="sp-o-comment">0</div>
										
									</div>
								</div>
								<div class="sp-par">
									<div class="sp-cost">От 17000 тг</div>
									<div class="sp-rating" style="background:url(../images/star_sprite.png);width:0px;height:15px;"></div>
								</div>
							</div>
							<div class="sp-photos">
								<img src='../data/photos/2428/20466_8s.jpg' alt=""><img src='../data/photos/2428/20467_2s.jpg' alt=""><img src='../data/photos/2428/20468_5s.JPG' alt=""><img src='../data/photos/2428/27028344s.jpg' alt="">
							</div>
						</a>
						...
						<a href="/ankets/2387">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/2387/2387a.jpg' alt="Лимузин на свадьбу роддом"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>Лимузин на свадьбу роддом</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">1548</div>
										<div class="sp-o-comment">0</div>
							...
							<div class="sp-photos">
								<img src='../data/photos/2387/20203_IMG_7026s.JPG' alt=""><img src='../data/photos/2387/20204_IMG_8004s.JPG' alt=""><img src="../images/spisok/champagne.png"><img src="../images/spisok/bouquet.png">
							</div>
						</a>
						...
						<a href="/ankets/2177">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/2177/2177a.jpg' alt="Лимузины Астаны!"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>Лимузины Астаны!</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
							...
							<div class="sp-photos">
								<img src='../data/photos/2177/18396_8s.jpg' alt=""><img src='../data/photos/2177/18397_4s.jpg' alt=""><img src='../data/photos/2177/18398_1bs.jpg' alt=""><img src='../data/photos/2177/18399_cad1s.jpg' alt="">
							</div>
						</a>
						...
						<a href="/ankets/1882">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/1882/1882a.png' alt="Двухэтажный автобус аренда"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>Двухэтажный автобус аренда</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">2872</div>
										<div class="sp-o-comment">0</div>
										
									</div>
								</div>
								<div class="sp-par">
									<div class="sp-cost">От 50000 тг</div>
									<div class="sp-rating" style="background:url(../images/star_sprite.png);width:0px;height:15px;"></div>
								</div>
							</div>
							<div class="sp-photos">
								<img src='../data/photos/1882/16287_obshiivids.jpg' alt=""><img src="../images/spisok/balloons.png"><img src="../images/spisok/champagne.png"><img src="../images/spisok/bouquet.png">
							</div>
						</a>
						...
						<a href="/ankets/1043">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/1043/1043_1043ba.jpg' alt="LuxCar - Лучшие лимузины"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>LuxCar - Лучшие лимузины</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">2817</div>
										<div class="sp-o-comment">0</div>
							...
							<div class="sp-photos">
								<img src='../data/photos/1043/11189_Maybach57s.jpg' alt=""><img src='../data/photos/1043/11194_Chrysler_C300_2016_04s.jpg' alt=""><img src="../images/spisok/champagne.png"><img src="../images/spisok/bouquet.png">
							</div>
						</a>
						...
						<a href="/ankets/932">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/932/932a.jpg' alt="WEDCAR ПРОКАТ АВТО"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>WEDCAR ПРОКАТ АВТО</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">3289</div>
										<div class="sp-o-comment">0</div>
							...
							<div class="sp-photos">
								<img src='../data/photos/932/10264_limousine-lincoln-white-stretch1s.jpg' alt=""><img src='../data/photos/932/10265_b5eb98a5a5a7e300acefc1a74c9e34f6e51s.jpg' alt=""><img src='../data/photos/932/10266_hummer_1s.jpg' alt=""><img src='../data/photos/932/10267_m31_0_rus.jpg' alt="">
							</div>
						</a>
						...
						<a href="/ankets/928">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/928/928a.jpg' alt="LimoRent"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>LimoRent</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">3000</div>
										<div class="sp-o-comment">0</div>
							...
							<div class="sp-photos">
								<img src='../data/photos/928/10220_1633340s.JPG' alt=""><img src='../data/photos/928/10221_DSC_0069s.JPG' alt=""><img src='../data/photos/928/10223_DSC_0013s.JPG' alt=""><img src='../data/photos/928/10225_DSC_0023s.JPG' alt="">
							</div>
						</a>
						...
						<a href="/ankets/840">
							<div class="sp-all-about">
								<div class="sp-avatar"><img src='../data/photos/840/840a.jpg' alt="7 zvezd"></div>
								<div class="sp-naa">
									<div class="sp-name"><span>7 zvezd</span></div>
									<div class="sp-other">
										<div class="sp-o-address">Нур-Султан</div>
										<div class="sp-o-view">2838</div>
										<div class="sp-o-comment">0</div>
										
									</div>
								</div>
								<div class="sp-par">
									<div class="sp-cost">От 10000 тг</div>
									<div class="sp-rating" style="background:url(../images/star_sprite.png);width:0px;height:15px;"></div>
								</div>
							</div>
							<div class="sp-photos">
								<img src='../data/photos/840/19467_408006255s.jpg' alt=""><img src='../data/photos/840/19468_444977735s.jpg' alt=""><img src='../data/photos/840/19469_933298134s.jpg' alt=""><img src='../data/photos/840/19470_734193740s.jpg' alt="">
							</div>
						</a>
	...
	<div class="nb-descr">
		<div class="nb-text">
			<div class="wrap">
				<div class="nb-mob">
					<h2>Аренда лимузинов в Астане: сделайте праздник незабываемым!</h2>
					<div class="cb-sep"><img src="../images/b2-sep.png" alt="" /></div>
					<div class="nb-inf">
						<p>Аренда лимузинов – услуга, которая пользуется огромным спросом, и предоставляется множеством компаний. Прежде чем отдать предпочтение той или иной организации, необходимо ознакомиться с ценовой политикой, отзывами и предлагаемым ассортиментом. Ведь транспорт на празднике – это не только «лицо» торжества, но и безопасность гостей, «виновников» мероприятия. Компания 1Show.kz – проверенный организатор различного рода торжеств, который дарит приятные эмоции. С нами аренда лимузинов в Астане – пройдет «без сучка, без задоринки». Ваш праздник будет надежно застрахован от любых форс-мажоров!</p>
<h3>Лимузин – ярко, стильно и роскошно!</h3>
<p>Мечтаете о запоминающемся празднике? Закажите презентабельный лимузин и почувствуйте себя кинозвездой, купающейся в лучах славы! Лимузин – это:</p>
<ul>
<li>модно;</li>
<li>престижно;</li>
<li>эффектно;</li>
...
<p>Найти свадебный лимузин, благодаря услугам лучшего организатора торжеств, просто, быстро и экономично!</p>
<h3>Мы предлагаем:</h3>
<ul>
<li>широкий выбор марок лимузинов, удовлетворяющий самого взыскательного клиента;</li>
<li>роскошную цветовую гамму, гармонично подчеркивающую характер торжества;</li>
<li>приятные цены, позволяющие сэкономить;</li>
<li>отличное состояние автомобилей, благодаря регулярному строгому техническому осмотру;</li>
<li>квалифицированных водителей с большим стажем работы;</li>
<li>высокий уровень обслуживания;</li>
<li> индивидуальный подход к каждому клиенту.</li>
</ul>
<p>Аренда лимузинов в Астане: доступно, удобно и элитно! Мы ждем ваших звонков, чтобы сделать любой праздник сказочным, волшебным, очаровательным с королевскими нотками роскоши, наслаждения и удивительных воспоминаний!</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="popup login-box">
			<div class="auth">
				<div class="pop-box">
					...
					<form class="pop-auth">
						<input type="hidden" name="authtoken" value="Pm0z3Cxb61sm7Tcs3rFBZo3T30eB19z9">
					...
					<div class="pop-nr">
						...
						<div class="pop-nr-link"><a href="../signup.html">Зарегистрироваться</a></div>
					</div>
				</div>
			</div>
		</div>
...
</html><?php /**PATH C:\xampp\htdocs\upwork\resources\views/catalog/transportnye_uslugi.blade.php ENDPATH**/ ?>